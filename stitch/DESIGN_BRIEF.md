...
- RecoverGrid Atlas turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser operations app called RecoverGrid Atlas. It should be a Vite React app for tracking incident cards, retry attempts, supervisor decisions, PR review state, recovery notes, and final gate outcomes. Include status filters, editable local notes, a chronological recovery timeline, local pe…
...
- Record Operations - RecoverGrid Atlas
- Record Editor - RecoverGrid Atlas
- Pipeline Board - RecoverGrid Atlas
- Settings and Preferences - RecoverGrid Atlas
- Empty and Error Recovery - RecoverGrid Atlas

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - RecoverGrid Atlas
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - RecoverGrid Atlas
...
SCREEN_SPEC_3:
- exact_screen_title: Pipeline Board - RecoverGrid Atlas
...
SCREEN_SPEC_4:
- exact_screen_title: Settings and Preferences - RecoverGrid Atlas
...
SCREEN_SPEC_5:
- exact_screen_title: Empty and Error Recovery - RecoverGrid Atlas
